...
capture <- read.csv("Data/nifflers_capture.csv")
capture <- read_csv("Data/nifflers_capture.csv")
treasure <- read.csv("Data/nifflers_treasure.csv")
recruitment <- read_csv("Data/nifflers_recruitment.csv")
...
# This will source your rscript and run it
